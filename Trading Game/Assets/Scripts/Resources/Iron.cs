...
public class Iron : Resources
{
    ...
    public Iron(float initialAmount, float equilibrium_price, float equilibrium_qty, float price_elasticity, float demand_shift, float price_shift) : base(initialAmount, equilibrium_price, equilibrium_qty, price_elasticity, demand_shift, price_shift)
    {
    ...
    public Iron(params float[] initialValues) : this(initialValues[0], initialValues[1], initialValues[2], initialValues[3], initialValues[4], initialValues[5]) { }
